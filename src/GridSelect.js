...
Memory.GridSelect.prototype = {
	create: function () {
		...
		var size1Btn = this.add.button(90, 110, 'sizeButtons', function() {this.setGridSize(3, 3)}, this);
		...
		var size3Btn = this.add.button(90, 230, 'sizeButtons', function() {this.setGridSize(5, 5)}, this);
		size3Btn.loadTexture('sizeButtons', 2);
		var size4Btn = this.add.button(510, 230, 'sizeButtons', function() {this.setGridSize(6, 6)}, this);
		size4Btn.loadTexture('sizeButtons', 3);
		var size5Btn = this.add.button(90, 350, 'sizeButtons', function() {this.setGridSize(7, 7)}, this);
		size5Btn.loadTexture('sizeButtons', 4);
		var size6Btn = this.add.button(510, 350, 'sizeButtons', function() {this.setGridSize(8, 8)}, this);
